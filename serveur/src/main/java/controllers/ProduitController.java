...
public class ProduitController {
    ...
    /**
     * Retourne la moyenne des notes données par les utilisateurs pour le produit passé dans la requête
     * @param request : La requête envoyé par le front
     * @return : la moyenne
     */
    public static double getReviewAverage(HttpServletRequest request) {
        ...
        average = getProductReviewAverage(idProduit, typeProduit);
        return average;
    }
