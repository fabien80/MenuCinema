...
export class TmdbService {
    ...
    async TopMovie(query: SearchMovieQuery): Promise<SearchMovieResponse> { // a finir
        ...
        //recrire le module, par default affiche top movie, sinon si filtre sur nom, les autres filtres disparaissent
        // si filtre sur note ou categorie, effectuer cette requete.
        //https://api.themoviedb.org/3/discover/movie?api_key=040fc302130d6412705f5f025c30dbe1&language=en-US&vote_average.gte=9&vote_count.gte=10&sort_by=popularity.desc&with_genres=Action
    }
